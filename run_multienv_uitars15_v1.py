...
def config() -> argparse.Namespace:
    ...
    # logging related
    parser.add_argument("--result_dir", type=str, default="./results_uitars15_v1_round1")
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                # Always use standard UITARS agent; attack handled by AttackableDesktopEnv
                agent = UITARSAgent(
                    model=args.model,
                    action_space=args.action_space,

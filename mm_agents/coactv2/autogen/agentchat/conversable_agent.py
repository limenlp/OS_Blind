...
class ConversableAgent(LLMAgent):
    ...
    def __init__(
        ...
        self._oai_system_message = [{"content": system_message, "role": "system"}] if system_message is not None else []
    ...
    def system_message(self) -> str:
        ...
        return self._oai_system_message[0]["content"] if self._oai_system_message else ""

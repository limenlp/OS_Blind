...
def get_googledrive_file(env, config: Dict[str, Any]) -> Any:
    ...
    @args: keys in config dict
        settings_file(str): target filepath to the settings file for Google Drive authentication, default is 'settings/googledrive/settings.yml'
    ...
    """
    settings_file = config.get('settings_file', 'settings/googledrive/settings.yml')
